...
const STRINGS = {
  en: {
    ...
    helpLocation:
      'No location? Use "Try enabling location again", or type an address, a Google Maps link, or coordinates instead. Planning ahead for a different spot? Switch the Live / Custom toggle up top.',
  ...
  he: {
    ...
    helpLocation:
      'אין מיקום? השתמש ב"נסה להפעיל מיקום שוב", או הקלד כתובת, קישור לגוגל מפות, או קואורדינטות במקום. מתכנן מראש למקום אחר? החלף בין נוכחי/מותאם למעלה.',
